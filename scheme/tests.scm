...
;;; **********************************
(define first_base 5.5)
(define second_base 12.1)
(define height 2.3)
(define trapezoid_area (* (/ (+ first_base second_base) 2) height))
trapezoid_area
; expect 20.24

(eval (cons 'car '(' (34 3 4))))
; expect 34

(begin (define s (cons 1 2)) (cons s s))
; expect ((1 . 2) 1 . 2)
(begin (+ 1 2 3) (define larb 14))
; expect larb
(begin (- 1 1) (/ 4 2) (begin (* 1 4) '(1 2 3)))
; expect (1 2 3)

(lambda (t v) (+ t v))
; expect (lambda (t v) (+ t v))
(define rick_and_morty (lambda (rick morty) (+ rick morty)))
; expect rick_and_morty

(lambda (x) (define x 3))
; expect (lambda (x) (define x 3))
((lambda (x y) (+ (+ x 3) (+ y 7))) 1 2)
; expect 13
(define (test_one x y)
  (define (test_two x z)
    (+ x (* y 2) (+ 4 z)))
